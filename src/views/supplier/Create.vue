      ...
      <form @submit.prevent="storeSupplier">
        ...
        <div class="flex flex-col gap-3 my-4">
          ...
          <div class="flex flex-col gap-2 items-start w-full">
            ...
            <textarea id="address" placeholder="Masukan Alamat Supplier" v-model="address" class="bg-white shadow-sm border border-b-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-b-blue-500 block w-full p-2.5" />
